...
class Salary_sources extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Sumber Gaji';
		$this->vars['employees'] = $this->vars['employee_references'] =$this->vars['salary_sources'] = TRUE;
		$this->vars['content'] = 'employees/salary_sources';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'salary_sources', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'salary_sources');
	...
	private function validation() {
		...
		$val->set_rules('option_name', 'Sumber Gaji', 'trim|required');
