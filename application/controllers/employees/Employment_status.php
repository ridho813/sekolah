...
class Employment_status extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Status Kepegawaian';
		$this->vars['employees'] = $this->vars['employee_references'] =$this->vars['employment_status'] = TRUE;
		$this->vars['content'] = 'employees/employment_status';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'employment_status', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'employment_status');
	...
	private function validation() {
		...
		$val->set_rules('option_name', 'Status Kepegawaian', 'trim|required');
