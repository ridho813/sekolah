...
class Employments extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Pekerjaan';
		$this->vars['employees'] = $this->vars['employee_references'] =$this->vars['employments'] = TRUE;
		$this->vars['content'] = 'employees/employments';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'employments', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'employments');
	...
	private function validation() {
		...
		$val->set_rules('option_name', 'Pekerjaan', 'trim|required');
