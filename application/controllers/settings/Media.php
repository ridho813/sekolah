...
class Media extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Pengaturan Media';
		$this->vars['settings'] = $this->vars['media_settings'] = TRUE;
		$this->vars['content'] = 'settings/media';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_settings->get_where($keyword, 'media', 'rows', $limit, $offset);
			$total_rows = $this->m_settings->get_where($keyword, 'media');
