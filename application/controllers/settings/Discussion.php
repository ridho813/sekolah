...
class Discussion extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Pengaturan Diskusi';
		$this->vars['settings'] = $this->vars['discussion_settings'] = TRUE;
		$this->vars['content'] = 'settings/discussion';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_settings->get_where($keyword, 'discussion', 'rows', $limit, $offset);
			$total_rows = $this->m_settings->get_where($keyword, 'discussion');
