...
class Social_account extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Pengaturan Jejaring Sosial';
		$this->vars['settings'] = $this->vars['social_account_settings'] = TRUE;
		$this->vars['content'] = 'settings/social_account';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_settings->get_where($keyword, 'social_account', 'rows', $limit, $offset);
			$total_rows = $this->m_settings->get_where($keyword, 'social_account');
