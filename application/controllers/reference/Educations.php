...
class Educations extends Admin_Controller {
	...
	public function index() {
		...
		$this->vars['content'] = 'reference/educations';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'educations', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'educations');
