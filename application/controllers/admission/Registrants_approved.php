...
class Registrants_approved extends Admin_Controller {
	...
	public function __construct() {
		parent::__construct();
		$this->load->model(['m_registrants_approved', 'm_majors']);
		$this->pk = M_registrants_approved::$pk;
		$this->table = M_registrants_approved::$table;
	}
	...
	public function index() {
		$this->vars['title'] = 'Pendafar Diterima';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_registrants_approved->get_where($keyword, 'rows', $limit, $offset);
			$total_rows = $this->m_registrants_approved->get_where($keyword);
