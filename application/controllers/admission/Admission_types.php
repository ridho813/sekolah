...
class Admission_types extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Jalur Pendaftaran';
		$this->vars['admission'] = $this->vars['admission_types'] = TRUE;
		$this->vars['content'] = 'admission/admission_types';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'admission_types', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'admission_types');
	...
	private function validation() {
		...
		$val->set_rules('option_name', 'Jalur Pendaftaran', 'trim|required');
