...
class Monthly_incomes extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Penghasilan Bulanan';
		$this->vars['academic'] = $this->vars['academic_references'] = $this->vars['monthly_incomes'] = TRUE;
		$this->vars['content'] = 'academic/monthly_incomes';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'monthly_incomes', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'monthly_incomes');
	...
	private function validation() {
		...
		$val->set_rules('option_name', 'Penghasilan Bulanan', 'trim|required');
