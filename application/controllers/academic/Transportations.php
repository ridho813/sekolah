...
class Transportations extends Admin_Controller {
	...
	public function index() {
		$this->vars['title'] = 'Moda Transportasi';
		$this->vars['academic'] = $this->vars['academic_references'] = $this->vars['transportations'] = TRUE;
		$this->vars['content'] = 'academic/transportations';
	...
	public function pagination() {
		if ($this->input->is_ajax_request()) {
			...
			$query = $this->m_options->get_where($keyword, 'transportations', 'rows', $limit, $offset);
			$total_rows = $this->m_options->get_where($keyword, 'transportations');
	...
	private function validation() {
		...
		$val->set_rules('option_name', 'Moda Transportasi', 'trim|required');
